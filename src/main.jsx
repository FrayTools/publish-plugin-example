...
// Import FrayToolsPluginCore.js and BasePublishPlugin.js
import FrayToolsPluginCore from '@fraytools/plugin-core';
import BasePublishPlugin from '@fraytools/plugin-core/lib/base/BasePublishPlugin';

/**
 * Example view for the publish plugin.
 */
class MyPublishPlugin extends BasePublishPlugin {
  constructor(props) {
    super(props);
...
// Informs FrayToolsPluginCore of the default config metadata for MyPublishPlugin when it first gets initialized
...
FrayToolsPluginCore.setupHandler = (props) => {
  ...
  appContainer.className = 'MyPublishPluginWrapper';
  document.body.appendChild(appContainer);

  // Load the component with its props into the document body
  ReactDOM.render(<MyPublishPlugin {...props} />, appContainer);
};
